...
/* package TheoremProvers-0.1.0.0 */
#ifndef VERSION_TheoremProvers
#define VERSION_TheoremProvers "0.1.0.0"
#endif /* VERSION_TheoremProvers */
#ifndef MIN_VERSION_TheoremProvers
#define MIN_VERSION_TheoremProvers(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_TheoremProvers */
...
#define CURRENT_COMPONENT_ID "TheoremProvers-0.1.0.0-inplace-TheoremProvers"
